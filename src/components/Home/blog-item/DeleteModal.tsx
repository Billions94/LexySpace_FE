...
interface DeleteModalProps {
    ...
    deleteBlogPost: (id: string | undefined) => Promise<void>
}

const DeleteModal = ({ id, smShow, setSmShow, deleteBlogPost }: DeleteModalProps) => {
        ...
        <Modal id='deleteModal'
          ...
          <Modal.Body className='m-auto'>
              ...
              <div className='m-auto mt-2'>
                <Button variant="danger" className='modalbtn' onClick={() => navigateHome(id)}>Delete</Button>
              </div>
              <div className='m-auto mt-2'>
                <Button className='modalbtn-cancel' onClick={() => setSmShow(false)}>Cancel</Button>
              </div>
          </Modal.Body>
        </Modal>
      </div>
